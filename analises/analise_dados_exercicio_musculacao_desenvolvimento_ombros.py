...
print('Somente Desenvolvimento de Ombros, ordenado por Peso e Repetições acententemente')
df_exercicio = dataframe_exercicios.query('exercicio == "Desenvolvimento de Ombros"')
df_exercicio = df_exercicio.sort_values(by=['data', 'peso', 'repeticoes'], ascending=True)
print(show_dataframe(df_exercicio.head(10)))

print('Somente Desenvolvimento de Ombros, ordenado por Peso e Repetições acententemente e agrupado por pelo mês da data')
